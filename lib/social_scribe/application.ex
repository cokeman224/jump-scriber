defmodule SocialScribe.Application do
  ...
  def start(_type, _args) do
    # ETS table for Salesforce PKCE code_verifier storage (keyed by state)
    :ets.new(:ueberauth_salesforce_pkce, [:set, :public, :named_table])

    children = [
      SocialScribeWeb.Telemetry,
      SocialScribe.Repo,
      SocialScribe.AskAnythingStore,
