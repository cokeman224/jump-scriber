defmodule SocialScribe.HubspotApi do
  ...
  defp format_contact(%{"id" => id, "properties" => properties}) do
    %{
      ...
      avatar_url: hubspot_avatar_url(properties["hs_avatar_filemanager_key"])
    }
  end

  # HubSpot avatar: file manager key requires File Manager API to resolve URL.
  # Automatically enriched avatars are not exposed via API.
  defp hubspot_avatar_url(nil), do: nil
  defp hubspot_avatar_url(""), do: nil
  defp hubspot_avatar_url(_key), do: nil
