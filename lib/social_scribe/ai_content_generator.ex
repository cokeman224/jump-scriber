  ...
  def generate_salesforce_suggestions(meeting) do
    case Meetings.generate_prompt_for_meeting(meeting) do
      ...
      {:ok, meeting_prompt} ->
        ...
        - Job title (Title)
        - Mailing address: Street (MailingStreet), City (MailingCity), State (MailingState), PostalCode (MailingPostalCode), Country (MailingCountry)
        ...
        Return your response as a JSON array of objects. Each object should have:
        - "field": the Salesforce field name (use exactly: FirstName, LastName, Email, Phone, MobilePhone, Title, MailingStreet, MailingCity, MailingState, MailingPostalCode, MailingCountry)
        - "value": the extracted value
        - "context": a brief quote of where this was mentioned
        - "timestamp": the timestamp in MM:SS format where this was mentioned
        ...
        [
          {"field": "Phone", "value": "555-123-4567", "context": "John mentioned 'you can reach me at 555-123-4567'", "timestamp": "01:23"},
          {"field": "Title", "value": "VP Sales", "context": "Sarah said she is VP Sales", "timestamp": "05:47"}
        ]
